  ...
  const steps = [
    {
      ...
      title: "Find a Bike",
      description:
        "Find the nearest available CycleEazy station using our station finder.",
    },
    {
      number: "02",
      icon: "🔓",
      title: "Unlock",
      description:
        "Choose your bike and unlock it quickly using your CycleEazy account.",
    },
    {
      number: "03",
      icon: "🚲",
      title: "Ride",
      description:
        "Enjoy your ride and return the bike to any available CycleEazy station.",
    },
  ];

  return (
    <section data-reveal className="reveal-section bg-white py-20">
